...
export async function GET(request: NextRequest) {
  console.log("[API Proxy] ===== GET CHALLENGES XP REQUEST START =====")
  ...
  try {
    ...
    const targetUrl = `${API_BASE_URL}v1/challenges/get_challenges_xp`
    ...
    if (!response.ok) {
      ...
      return NextResponse.json(
        { 
          error: errorText || 'Failed to get challenges XP',
    ...
    console.log("[API Proxy] ===== GET CHALLENGES XP REQUEST SUCCESS =====")
