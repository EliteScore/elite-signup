...
export async function POST(request: NextRequest) {
  console.log("[API Proxy] ===== REFRESH MONTHLY CHALLENGES REQUEST START =====")
  ...
  try {
    ...
    const targetUrl = `${API_BASE_URL}v1/challenges/refresh/monthly`
    ...
    if (!response.ok) {
      ...
      return NextResponse.json(
        { 
          error: errorText || 'Failed to refresh monthly challenges',
    ...
    console.log("[API Proxy] ===== REFRESH MONTHLY CHALLENGES REQUEST SUCCESS =====")
