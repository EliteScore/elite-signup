...
export async function GET(request: NextRequest) {
  console.log("[API Proxy] ===== GET MONTHLY CHALLENGES REQUEST START =====")
  ...
  try {
    ...
    const targetUrl = `${API_BASE_URL}v1/challenges/get_monthly`
    ...
    if (!response.ok) {
      ...
      return NextResponse.json(
        { 
          error: errorText || 'Failed to get monthly challenges',
    ...
    console.log("[API Proxy] ===== GET MONTHLY CHALLENGES REQUEST SUCCESS =====")
