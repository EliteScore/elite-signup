...
export async function GET(request: NextRequest) {
  console.log("[API Proxy] ===== PREFERENCES GET REQUEST START =====")
  ...
  try {
    ...
    const targetUrl = `${API_BASE_URL}v1/preferences/get_preferences`
    ...
    if (!response.ok) {
      ...
      return NextResponse.json(
        { 
          error: errorText || 'Failed to get preferences',
    ...
    console.log("[API Proxy] ===== PREFERENCES GET REQUEST SUCCESS =====")
